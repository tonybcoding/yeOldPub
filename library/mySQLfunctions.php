...
///////////////////////////////////////////////////////////////////////////////
/*               Beginning of DB Connectivity Functions                      */
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
/*               End of DB Connectivity Functions                            */
///////////////////////////////////////////////////////////////////////////////



///////////////////////////////////////////////////////////////////////////////
/*               Beginning of Populated Menus & Links Functions              */
///////////////////////////////////////////////////////////////////////////////


///////////////////////////////////////////////////////////////////////////////

function createTableJumpMenu($name) {
    printf(LB."<form name=\"".$name."\">".LB);
    printf("<select name=\"".$name."\" onChange=\"MM_jumpMenu('parent',this,0)\">".LB);
    $categories = getCategories();
    printf("<option value=\"\">Choose a table</option>");
    for ($i=0; $i<count($categories); $i++) {
        if(($categories[$i][6]=="Table") && ($categories[$i][3]!="Inactive")) {
            printf("<option value=\"welcometoyeoldpub.php?loc=".$categories[$i][0]."\">".$categories[$i][1]."</option>");
        }
    }
    printf("</select>".LB);
    printf("</form>".LB);
...
///////////////////////////////////////////////////////////////////////////////
/*               End of Populated Menus & Links Functions                    */
///////////////////////////////////////////////////////////////////////////////
function getTheme($themeid) {
    if (($themeid < 1) || ($themeid == NULL)) $themeid = 5;  // if a category doesn't have a theme assigned, default
    $query = sprintf("SELECT * FROM `theme` WHERE `id` = '%u'",
                             mysql_real_escape_string($themeid));
    $result = mysql_query($query);
    $row = mysql_fetch_assoc($result);
    $themearray[0] = $row['name'];
    $themearray[1] = $row['cssfile'];
    mysql_free_result($result);
    return $themearray;
}

function getContentAssignedtoCategory($categoryid) {
    $query = sprintf("SELECT contentID FROM contenttocategory WHERE categoryID = '%u' ORDER BY `id` DESC",
